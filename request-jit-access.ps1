$MyResource = Get-AzResource -Id /subscriptions/3762d87c-ddb8-425f-b2fc-29e5e859edaf/resourceGroups/test-001/providers/Microsoft.Compute/virtualMachines/JIT-VM-002
$JitPolicy = (@{
